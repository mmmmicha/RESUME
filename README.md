...
```
안녕하세요! 저는 책임감과 주인의식이 강한 개발자입니다. 항상 열린 자세로 소통하며 의사표현을 주저하지 않습니다.

주로 node.js와 typescript를 사용하여 개발 업무를 수행하며, AWS를 활용하여 인프라 구축 및 배포를 경험했습니다.

저는 스마트홈과 IoT에 대한 도메인 경험을 가지고 있습니다. 다만 다른 도메인에 대한 도전도 즐길 준비가 되어있습니다.

협업을 통해 동료들과 함께 일하며, 창의적인 아이디어를 공유하고 팀의 목표를 달성하는 데 기여하고 싶습니다.
